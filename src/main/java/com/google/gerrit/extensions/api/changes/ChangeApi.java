...
public interface ChangeApi {
    ...
    ChangeInfo get(EnumSet<ListChangesOption> options, ImmutableListMultimap<String, String> pluginOptions) throws RestApiException;

    default ChangeInfo get(ImmutableListMultimap<String, String> pluginOptions) throws RestApiException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
